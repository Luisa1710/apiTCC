package com.tcc.api.servicios.implementaciones;

import com.tcc.api.entidades.Zona;
import com.tcc.api.repositorios.Zonarepositorio;
import com.tcc.api.servicios.ServicioGenerico;
    ...
    public Boolean eliminar(Integer id) throws Exception {
        ...
        try {
          ...
          if (zonarepositorio.existsById(id)){
              zonarepositorio.deleteAllById(id);
              return true;
